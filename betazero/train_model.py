...
def load_and_train_dir(model, dir_name="./games"):
    ...
    model.compile(optimizer=optimizer, loss={"policy_output": "kl_divergence", "value_output": "kl_divergence"}, metrics={"policy_output": ["mse", "accuracy"], "value_output": ["mse", "accuracy"]})
